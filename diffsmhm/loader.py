...
def find_and_write_most_massive_hosts(halo_file, host_mpeak_cut=0, export=True):
	...
	print(RANK, "begin (1)", flush=True)
	if RANK==0: print(len(pid_hosts_indices), flush=True)
	edits_made=0
	...
	print(RANK, "\t(1) done:", edits_made, flush=True)
