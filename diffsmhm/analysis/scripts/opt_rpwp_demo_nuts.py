...
outdir = "/home/jwick/diffsmhm/diffsmhm/analysis/scripts/output/rpwp_demo_nuts"
...
# we wrap as one input for blackjax
def logdensity(x):
    return logdensity_fn(**x)


# method to calculate rpwp
...
# non 0 mpi ranks just do computation
if RANK > 0:
    while True:
...
# RANK 0 continues with the HMC
    ...
    print("logdensity:", states.logdensity)

# 4) save output and plot results (rank 0 for IO, all for calculations)
...
if RANK == 0:
    ...
    plt.savefig("figures/rpwp_demo_nuts.png")
